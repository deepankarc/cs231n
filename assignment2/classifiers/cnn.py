...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    conv_a1, conv_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
    ...
    fc_a1, fc1_relu_cache = relu_forward(fc_a1)
    ...
    delta_l1 = relu_backward(delta_l2, fc1_relu_cache)
    if(use_bn == True):
    ...
    _, grads['W1'], grads['b1'] = conv_relu_pool_backward(delta_l1_res, conv_cache)
